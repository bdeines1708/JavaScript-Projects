...
//This function takes a string parameter you set earlier for placement sound('./media/place.mp3')
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line gives us access to methods and poroperties to use on canvas.
    const c = canvas.getContext('2d');
    //This line indicates where rthe start of a lines x axis is
    let x1 = coordX1,
    ...
    animateLineDrawing();
    //This line waits for one second. Then, clears canvas, resets game, and allows clicking again
    setTimeout(function () { clear(); resetGame(); }, 1000)
}
//This function resets the game in the event of a tie or a win.
function resetGame() {
    //This loop iterates through each HTML element i.
    for (let i = 0; i < 9; i++) {
